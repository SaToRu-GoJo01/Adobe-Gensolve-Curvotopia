...
def load_images_from_directory(directory_path):
    ...
    for shape_name in shape_names:
        shape_directory = os.path.join(directory_path, shape_name)
...
# Load dataset
dataset_directory = '../dataset_created'  # Path to the generated dataset
images, labels = load_images_from_directory(dataset_directory)

# Preprocess data
images = images.reshape((images.shape[0], 128, 128, 1)) / 255.0
...
# Save the model
shape_classifier_model.save('./CURVES_MODELS/curves_made_model.h5')
